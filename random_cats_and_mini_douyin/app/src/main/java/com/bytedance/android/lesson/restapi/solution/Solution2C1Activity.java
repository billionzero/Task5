...
//                Log.d(TAG, "onBindViewHolder() called with: viewHolder = [" + viewHolder + "], i = [" + i + "]");
    ...
    public void requestData(View view) throws InterruptedException {
        ...
        thread=new Thread(){
            ...
            public void run(){
                ...
                Call<List<Cat>> call=iCatService.getCat();
                ...
                call.enqueue(new Callback<List<Cat>>() {
                    ...
                    public void onResponse(Call<List<Cat>> call, Response<List<Cat>> response) {
                        /**
                         * 这个部分遇到很多问题，由于Gson是Array类型的，所以必须要将Call的类型更改为List#<Cat></Cat>#
                         * 从而下面loadPics para2是List<Cat>类型的
                         *
                         */
...
//                Log.d(TAG, "onResponse: "+response.body());
                    ...
                    public void onFailure(Call<List<Cat>> call, Throwable t) {
                        ...
                        Toast.makeText(Solution2C1Activity.this,"Gson格式不正确array,array,string,string,int,int" +
                                "\n在某些Cat类中存在缺省，暂未实现，请授教"+t,Toast.LENGTH_LONG).show();
                        restoreBtn();
                    }
                });
        ...
        thread.start();
        Log.d(TAG, "requestData: "+thread.getState());
